...
volume_dir="${SQLITE_VOLUME_DIR:-${HOME}/${container_name}_volume}"
...
export TEST_CASE_CPUS=${TEST_CASE_CPUS:-4}

docker run -v "${volume_dir}:/db" \
  -e JOURNAL_MODE -e DB_DIRECTORY -e BEFORE_TESTS_QUERY \
  -e TEST_CASE \
  -e QUERIES_TO_EXECUTE -e QUERIES_BATCH_SIZE -e QUERIES_MAX_RATE \
