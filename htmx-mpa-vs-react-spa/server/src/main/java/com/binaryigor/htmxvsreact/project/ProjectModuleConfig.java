...
public class ProjectModuleConfig {
    ...
    InitializingBean projectTranslationsInitializer(Translations translations) {
        return () -> {
            translations.register(ProjectNameValidationException.class, (l, e) -> "Name can't be blank and needs to have between 3 and 50 characters");
            ...
            translations.register(ProjectDoesNotExistException.class, (l, e) -> "Project doesn't exist");
        };
    }
