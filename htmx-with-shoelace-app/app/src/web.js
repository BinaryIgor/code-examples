...
function errorDialog() {
    if (!_errorDialog) {
        _errorDialog = document.getElementById("error-dialog");
        _errorDialog.body = document.getElementById("error-dialog-body");
...
export function returnFullHTMLPage(res, body, status = 200) {
    returnHTML(res, `
        ...
        <body class="bg-background-50 text-800">
          <div hx-history="false" hx-history-elt id="root">${body}</div>
