    ...
    static EndpointResult task(HttpClient httpClient, Map<String, EndpointStats> endpointsStats) {
        ...
        try {
            ...
            if (endpoint.body == null) {
                requestBuilder = requestBuilder.method(endpoint.method, HttpRequest.BodyPublishers.noBody());
            } else {
                requestBuilder = requestBuilder.method(endpoint.method, HttpRequest.BodyPublishers.ofString(endpoint.body))
